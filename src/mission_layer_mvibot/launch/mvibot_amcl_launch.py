...
def generate_launch_description():
    ...
    amcl_param_file_arg=DeclareLaunchArgument(
        'amcl_param_file',
        default_value=os.path.join('/home/mvibot/floorCleaningRobot_ws/src/mission_layer_mvibot/param','amcl.yaml')
    )
    ...
    amcl_node=Node(
        ...
        # parameters=[configured_params,
        #             {'base_frame_id':[LaunchConfiguration("mvibot_seri"), "/base_link"],
        #              'odom_frame_id':[LaunchConfiguration("mvibot_seri"), "/odom"],
        #              'scan_topic': ["/",LaunchConfiguration("mvibot_seri"), "/laser/scan"],
		# 	         'map_topic': ["/",LaunchConfiguration("mvibot_seri"), "/map"]}],
    )
