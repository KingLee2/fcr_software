...
def generate_launch_description():
    ...
    declare_slam_params_file_cmd = DeclareLaunchArgument(
        ...
        default_value=os.path.join('/home/mvibot/floorCleaningRobot_ws/src/higher_layer_mvibot/param/mapper_params_lifelong.yaml'),
    ...
    declare_file_name_cmd = DeclareLaunchArgument(
        'map_file_name',
        default_value='/assets/maps/test_mapping_070426'
    )
