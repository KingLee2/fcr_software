...
#define NODE_MAIN_LOGGER_NAME "tf2_web_republisher_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtf2_web_republisher.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<tf2_web_republisher::TFRepublisher>";
