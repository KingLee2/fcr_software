...
{
  new (message_memory) tf2_web_republisher_interfaces::msg::TFArray(_init);
}

void TFArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tf2_web_republisher_interfaces::msg::TFArray *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TFArray_message_member_array[1] = {
  {
    ...
    offsetof(tf2_web_republisher_interfaces::msg::TFArray, transforms),  // bytes offset in struct
    ...
    fetch_function__TFArray__transforms,  // fetch(index, &value) function pointer
    assign_function__TFArray__transforms,  // assign(index, value) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TFArray_message_members = {
  "tf2_web_republisher_interfaces::msg",  // message namespace
  "TFArray",  // message name
  1,  // number of fields
  sizeof(tf2_web_republisher_interfaces::msg::TFArray),
...
get_message_type_support_handle<tf2_web_republisher_interfaces::msg::TFArray>()
{
  return &::tf2_web_republisher_interfaces::msg::rosidl_typesupport_introspection_cpp::TFArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tf2_web_republisher_interfaces, msg, TFArray)() {
  return &::tf2_web_republisher_interfaces::msg::rosidl_typesupport_introspection_cpp::TFArray_message_type_support_handle;
}
